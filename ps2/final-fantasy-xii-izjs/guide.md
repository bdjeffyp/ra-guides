...
**Show Off I (cont'd)**: Meanwhile, in the Southfall Passage zone, a Cultsworn Lich has a chance of spawning when a Lich divides at critical health. If you don't encounter it now while traveling through the area, perhaps hold off to find it until later on when level caps are no longer a concern.
...
**Show Off I (cont'd)**: You should be more than strong enough to handle Nekhbet, a rare game cockatrice that may appear in the Sand-swept Naze zone, at this point. If you are passing through for **Covered Up In Flowers/Treasure Hunter Mog** and you see it appear, take it out.
...
**Passage of Death** (Steal/Poach): With both the Thief's Cuffs and the Barheim Key, you are prepared to try to get the Deathbringer. The weapon is stolen from the rare game Ithuno in Barheim Passage: Special Op Sector 5. The fiend is similar to the Mimics in that it will appear as a treasure chest. It has a 20% chance of spawning at the end of the zone, nearby the one-time Arc Scale chest and directly next to a 90% spawning chest that may contain an Aero Mote or Glacial Staff.
...
**Show Off I (cont'd)**: While traversing Giza Plains during the Rains, there is a 20% chance of the Rain Dancer rare game spawning in a few of the zones. I found it in Toam Hills just south of the bridge where a Gigantoad was sleeping.
...
**Show Off I (cont'd)**: In Paramina Rift: Karydine Glacier, the rare game Anchag can spawn near the south center section of the zone if all enemies are defeated. Clear everyone out, including Wild Onions, then zone out and back in to find it wandering alone. It is a Dullahan type fiend.
...
- If you have the capability of inflicting Oil, Mateus is susceptible to it. With that status, fire element damage will still be boosted despite Mateus' resistance to it. 300% drops to 150%, but that's better than just the base 50% damage normally caused by fire element damage.
- A strategy used by RA user [Mimicmatter](https://retroachievements.org/user/mimicmatter) was to equip the Tourmaline Ring to reduce ice damage and prevent poison/sap as well as make use of Motes to deal damage. Motes are not affected by the Reflect status so you can use them to deal damage. Mimicmatter mentioned using Balance Motes to get rid of the Ice Azers as well so that they don't cure Mateus.
...
**Great Cockatrice Roundup** (Side Quest): You can now start this side quest, provided that you obtained the Feather of the Flock in the area that the Gil Snapper was found. Speak to Terra in the now empty cockatrice pen in the Nomad Village in Dry Giza Plains to kick off this event. There are six to find in total and this quest will take you previous locations to complete additional side quests and minigames to get the cockatrices to return to Giza.

**Dewdrop Jewelers** (Side Quest): As part of the Great Cockatrice Escape side quest, you'll find one of them in Eruyt Village speaking with Mjrn. After talking to the cockatrice named Chit, you'll find red sparkles called Dewdrop Pebbles. Gather them up and give them over to Mjrn. There will be eight around the village. After giving them to Mjrn, speak with Chit once more to get the last Dewdrop Pebble, then give that to Mjrn to complete the quest and send the first cockatrice back home.

**Great Cockatrice Roundup (cont'd)**: Another cockatrice is found in Jahara with a large group of garif near it in the Lull of the Land zone. Talk to the Garif Herder and the cockatrice to start the event. Tell the Garif Herder that the cockatrice is from Giza Plains and you'll be told to speak with the Great-chief. After getting a gift from the Great-chief, hand it over to the cockatrice then speak with the herder once more to end this portion of the quest.

**Great Cockatrice Roundup (cont'd)**: If you teleport to Dalmasca Estersand, you'll find a cockatrice right nearby in South Bank Village. Speak with the cockatrice to learn about their problem. Now you get to play a simplified version of the wolf/goat river crossing puzzle. Speak with the ferry operator, Tchigri, and take the wolf Nathyl along on the trip to North Bank. Cross back with no one. Do another crossing to North Bank, taking Arryl across. Return to South Bank once more with no one, then cross one more time with the cockatrice, Sassan. Follow after Sassan and speak with them to finish this portion of the quest.

**Great Cockatrice Roundup (cont'd)**: Back in Rabanastre's North End zone, a cockatrice is hiding in the northern most area. Talk to it and it will run off. If you haven't completed Dewdrop Jewelers so that Chit returns to Giza Plains, you won't be able to finish this portion of the quest. To catch this cockatrice, Renn, you need to hide among the pillars around the clan hall or the gambit shop. If Renn sees your coming from the front or the rear, they'll take off quickly and you can't catch up. So, come out from the pillars at Renn's side and use a WALKING pace. If you run out, Renn will bolt off. When you walk out from the side, Renn will still maintain their pace and then you can talk to them. Tell Renn that you are not ruffling their feathers. Meet back up with Renn near where this all started and tell them that Chit has returned to complete this portion of the quest.

**Great Cockatrice Roundup (cont'd)**: Make your way to Archades, either via Aerodrome or Teleport. If you haven't spoken to a cockatrice in Old Archades, head down there first and speak to that cockatrice in the Alley of Low Whispers zone. Head back up to Tsenoble in Archades proper and, with your sandalwood chop, take an elevator up to a new zone, the Grand Arcade. Right away you will see a large cockatrice surrounded by three imperial guards. The cockatrice will try to run from you but is much easier to catch than Renn. Just run around the center column and tap circle as you get close to catch them. Tell the cockatrice about the one in Old Archades and you'll complete this portion of the quest.

**Cartographer (cont'd)**: There is one more area besides Grand Arcade that is now accessible after Draklor Labs and obtaining a sandalwood chop. Head toward the northeast exit to Highgardern Terrace to have this zone registered for this achievement.

**Great Cockatrice Roundup (cont'd)**: Head to Balfonheim via the Aerodrome or Teleport. At the chocobo stable near the entrance, a cockatrice will be in the pen with the chocobos. Talk to the Chocobo Wrangler and let her see the Feather of the Flock. A Miffed Moogle will stroll up. Talk to them and then to Gurdy to end this portion of the quest.

**Great Cockatrice Roundup (cont'd)**: Once all of the cockatrices have been handled, the achievement will unlock. There is still a reward at Giza Plains Nomad Village to obtain. If it is Dry Season you can get the reward of two Hi-Ethers, but the achievement is already earned.

**Show Off I (cont'd)**: The Wary Wolf has a low chance of spawning in Mosphoran Highwaste - Summit Path instead of a Worgen. It spawned for me while entering the area from the western exit of Southern Skirts. It might be a pain to coax this rare game to appear without some luck. If you do happen to run across it (it looks like the wolves from Dalmasca Estersand but larger than the Worgen), take it out.

**Knight's Honor** (Characters?) Not sure how to categorize these particular achievements. Using the Attack command 10,000 times will unlock this achievement and will certainly be unlocked over the course of working on this set. I got it after Draklor Labs while doing some cleanup of hunts and side quests. Mileage will vary for others on when this unlocks.

**Show Off I (cont'd)**: In The Salikawood - Sun-dappled Path, eliminating the Wyldhares here will cause Spee to spawn in the southwest corner of the zone. Spee can cause confusion and absorbs Fire element.

**Cartographer (cont'd)**: While working on some side quest stuff after Draklor, I went into Nabreus Deadlands to work on the Medallions quest. While there, I grabbed the area map from an urn in the Vale of Lingering Sorrow zone. I won't enter every zone quite yet, but I was strong enough to deal with the monsters here to grab it now.

**Shelled Obstruction** (Hunts): Darksteel, a tortoise type mark, can be found in Sochen Cave Palace - Temptation Eluded. It is susceptible to Blind, Poison, Slow, and other status ailments. Blind is most beneficial since it relies primarily on physicals though it may pivot to Dark element magicks as it hits 20% HP. I had my white mage cast Bravery and Faith on the physical and magic attackers (especially since most elemental damage is resisted). I also put Berserk on my physical attacker with a Bacchus Wine to increase their damage output dramatically. Not too terrible of a fight overall. Return to the Homesick Man in Archades - Vint's Armaments to get the reward.

**The Things We Do...** (Hunts): Overlord is one of the headless humanoid enemies and can be found in the entry area of Sochen Cave Palace, Doubt Abandoned. The mark is a very strong physical attacker, likely to be buffed with Bravery at the start of the fight. Overlord is susceptible to Blind and Slow, which may be good debuffs to put on it. It has a skill called Pyromania that hits all that surround the mark for a ton of damage and will likely kill the seeq who is helping you. Buff yourself with Protect and Shell at the start. Once the mark's health gets around halfway down, it will take less damage and become more aggressive. As you get it down near 20% health, consider using your quickenings at this point or Overlord's Pyromania may wipe you out. Return to the seeq in Archades - Bulward's Technicks to get your reward.

**Old Legends, Decaying Bonds** (Hunts): The Lindwyrm only appears in Tchita Uplands - Garden of Life's Circle if the weather is cloudy. If it isn't cloudy or rainy when you first enter Tchita Uplands, leave the area and reenter to change it until then. Also, make sure your party consists of characters with odd levels. Lindwyrm uses Level 2 Sleep and Level 4 Break so being odd leveled will help remove that threat. Once you enter Garden of Life's Circle, the Lindwyrm will be the only monster in the zone. Prep buffs (Protect is probably all you need if you use Silence, but Regen couldn't hurt as well). Once you start the fight, Dispel any buffs on the mark, then start putting Silence and Blind debuffs on it. As the fight progresses, Lindwyrm will use Restore followed by Greater Barrier twice. Make sure to pay attention to the number of times it uses it. Once it has Restore/Greater Barrier the second time, it'll become more defensive and aggressive at 20% HP, like other marks. This is the moment to use quickenings. Return to Fermon in Old Archades - Alley of Muted Signs for the reward.

**Paramina Run** (Hunts): Trickster can be found in Paramina Rift - Frozen Brook. When you first enter the zone, Monid, a bangaa from the clan, will report if Trickster is in the zone or not. If not, use the opportunity to clear out the zone of fiends before trying to get Trickster to spawn. This includes the Ice Elemental that can appear here. Trickster will be much easier to handle if you aren't also dealing with the fodder in the area or the Ice Elemental's magic attacks and debuffs. Once the zone is clear of monsters, use the save crystal in Path of the Firstfall to restore MP as well as prepare for the fight. Set up gambits to provide buffs on the team throughout the fight. Have gambits for Dispel as well as applying Blind and/or Silence. Start off with physical attacks to get it's health down while also staying in one spot as Trickster runs around. No need to chase it as it will return to you. Once Trickster reaches 20% HP, it will put up White Wind to prevent status effects and a paling to make it immune to physical attacks. Additionally, any magic element will heal it except for one at this time. If you hit it with the correct element, it will shift its weakness. Choco-comet can be brutal as well but having healing gambits should be adequate. I made use of Decoy to direct physical attacks on Monid during this invulnerable phase and once the paling wore off, I killed Trickster fairly quickly after that. My party was at level 37 for this fight and it wasn't too much of a struggle. Return to Gurdy in Mt. Bur-Omisace for the reward.
...
**The Deserter's Revenge** (Hunts): Within the hidden areas of Barheim Passage is the West Annex, a place full of Dead Bones and Specters that love to spawn numerously. Bloodwing appears here along the southern most path, potentially with some of the undead enemies here. Bloodwing itself isn't much of a threat as it uses the typical bat enemy attacks. Blind does work and is a good approach to reduce incoming damage while also dealing with potential mobs of skeletons and ghosts. Return to South Bank Village when you are able for the reward.

**The Death Seraph** (Espers): Shortly after Bloodwing is the esper Zalera. This is an interesting fight as there will be a timer near the minimap counting down from five minutes. Fail to defeat the esper before the timer runs out and it is game over! A strategy I used was to have a party of three with two who could cast Curaja and a physical attacker. The physical attacker had the Ruby Ring on in order to have the Reflect status. The Curaja casters had gambits to cast the spell on an ally with Reflect status. This causes the spell to bounce back toward Zalera and the Dead Bones that appear with the esper, damaging them. Zalera is impervious to damage until all the Dead Bones are gone, OR if healing magic is reflected back! This makes taking out the esper fairly simple. One other gambit to use is Phoenix Downs on any ally. Since the esper is going to kill your characters with the Kill skill, just have Phoenix Downs (or Raise, if needed) to bring your dead back to continue the fight rather than healing since Kill can't be stopped.
...
**Show Off I (cont'd)**: A Pallicant (Nightmare type monster) will spawn in Ridorana Cataract - City of Other Days if you first eliminate all enemies in the zone, then leave and reenter the zone. It'll be found at the center crossroads.

**Trip to the City the Other Day** (Steal/Poach): Before killing Pallicant, steal from it! It has one item, the Gastrophetes, in its rare steal slot. Put on Thief's Cuffs on one or two characters and steal away while the non-stealers heal.
...
**Shikari Striker** (Characters?): This milestone achievement was unlocked during the Pharos climb. As long as you are persistent with having a Steal gambit set up, you'll certainly have this one unlocked as you approach the endgame.
...
**Reflecting the Dead** (Treasure?): There is a guaranteed one-time chest in Pharos Second Ascent - Station of Banishment with an Opal Ring. It's [chest 2 on the map](https://steamcommunity.com/sharedfiles/filedetails/?id=1292596668) found in a room south and center-left.

**Libra's Hunt** (Treasure?): There is a guaranteed one-time chest in Pharos Second Ascent - Station of Suffering with the Gastrophetes S crossbow. It's [chest 16 on the map](https://steamcommunity.com/sharedfiles/filedetails/?id=1292596668) found in a hallway north and center-left. DO NOT SELL THIS WEAPON! It is one of the 12 weapons for the **F.I.N.A.L. F.A.N.T.A.S.Y.** achievement and you must keep them all in your inventory!

**Stain is Mine to Bear** (Challenge): This one isn't too bad. My Basch, a Knight, was level 46 and Reddas at level 50. Buffed up prior to the fight with Bubble, Protect, Haste, and Bravery, I made short work of Gabranth. Make sure that only Basch and Reddas are active in the party and that Reddas' gambits are off. Once the battle begins and you start to attack, manually direct Reddas to attack as well. At 50% HP, a cutscene will play and then the battle resumes. You'll have to manually direct Reddas again to attack after that while Basch will continue to follow your gambit actions. If Basch is a magic user, do note that Gabranth will put up a paling that blocks magic damage for two minutes so you may be dependent on Reddas as your primary damage source during that time.
- Unfortunately, this achievement is not compatible with the following challenge with Cid and Famfrit. You will have to reset and do this fight again with only Balthier and Reddas.

**Fool of a Pirate** (Challenge): I skipped the cutscene that followed after Gabranth's defeat and the challenge achievement icon appeared to let me know that I had everything set up properly. Unlike the Gabranth challenge, Reddas can have his gambits on and should be used to support Balthier as much as possible. Make sure your gambits are set to target the enemy with the highest HP so that Famfrit is the primary target when they shows up.
- The first phase with just Cid should be similar to Gabranth in how it plays out. If buffs are wearing out, reapply them however you can, either with motes or spells, if Balthier has access to them.
- Phase two of this fight begins when Cid reaches 50% HP. Famfrit is summoned and Cid is invulnerable. Shift attacks to Famfrit and, if possible, target it's fire elemental weakness. If Balthier is a magic user, ensure Reddas can remove Silence with Echo Herbs or wear the Rose Corsage accessory. Cid will buff Famfrit, but there isn't really anything that can be done about that... This will be the longest part of this fight. Because my Balthier is a white mage, I ended up equipping him with the Treaty-Blade to do the physical damage, since his Holy Rod does no damage.
- Once Famfrit is down, resume the attack on Cid just like in the first phase. Switch weapons again to whatever is more effective for Cid than for Famfrit, if necessary. Feel free to close this out with quickenings as well once Cid nears death.

**Mage's Whisperings** (Characters?): I got this milestone achievement during the refight with Gabranth before the Cid/Famfrit challenge fight with Balthier as he flung spells. This will certainly be unlocked near the endgame or absolutely during the postgame RA set cleanup.

### Is there a Doctor in the House ➡️ Zodiac Age

**Race of Rikken** (Minigame): After all the cutscenes and back in Balfonheim port with control of Vaan, chat with Rikken. Talk to him one more time and he'll ask to start a race minigame. Accept and you'll be told how to play (rapidly alternate tapping on Cross and Circle buttons). Do just that and win to unlock this achievement. I'll be coming back to work on the other tiers and their associated achievements later.

**Double-Bladed Knife** (Bazaar): Sell 5 Windslicer Pinion, 7 Malboro Flower, and 9 Wind Crystal to unlock the Double-bladed Knife in the bazaar. Purchase it for 7500 gil to get the Zwill Crossblade and this achievement.

**Magepower Helm** (Bazaar): Sell 5 Charger Barding, 2 Chimera Head, and 1 Feystone to unlock Magepower Helm in the bazaar. Purchase it for 7500 gil to get the Magepower Shishak and this achievement.

**Quell a Brother's Hatred** (Challenge): You can walk onto the lift without having set up for the challenge ahead of time. The lift gives you time to make the setup and you'll know that you are good to go when you leave and reenter the lift and the challenge achievement icon appears. If you don't have all of your mist charges before activating the lift, consider using an elixir to restore them as you'll need to use quickenings to finish the fight. You can set up buffs while on the elevator. If Basch can't apply the buffs, set it up with another character, then step off the lift and return to restore the active challenge indicator. Once ready and the challenge is active, press the button on the lift to head to the boss fight!
- At 50% HP, a cutscene occurs and then Gabranth uses Renew to restore his HP to full. Keep at it and if buffs start to drop off, renew them with whatever means you have as you go.
- The second time at 50% HP, Gabranth gets faster and resists more damage. If you need to use support items like Elixirs to restore health, do so. At 20% HP, Gabranth begins to combo even more. Stay alive!
- Elixirs can also be used to spam quickenings. Start a set of quickenings when Gabranth gets close to death or is too aggressive. If you can't get a chain long enough to kill him, use an Elixir then run through quickenings again. Repeat until it is done.
- If you happen to have Reverse or Reverse Motes available, this battle can be greatly simplified as all of Gabranth's attacks will heal you. This is especially useful in the final leg as Gabranth becomes enraged.
- If you want to not lose all of the elixirs you used here so that you can have them for Ashe vs. Vayne and you were successful in getting this achievement, then reset and do the run again and just murder Gabranth quickly with a full team.

**Game of Thrones** (Challenge):After defeating Gabranth the final time, setup Ashe solo, doing the usual buffing prior to using the lift again. You'll know that you are set up properly if you activate the lift and the active challenge icon appears as the cutscene loads.
- Similar to Gabranth, using Elixirs to heal up and restore mist charges can be helpful since you aren't going to lose them anyway as there is no "end game save" system in Final Fantasy XII. Prep a gambit to use them if you have the quantity to support it, or just pop them manually when needed explicitly for the mist charges or urgent health. Reverse is also a great idea, if available.
- Got Dark Energy/Knots of Rust+Dark Matter? Perhaps give those a use during The Undying to get his health down to 20% HP (you'll know you reached that point when it uses Perfect Defense paling). Then start using quickening spam with elixirs.
- Did you happen to get a Baltoro's Seed? The Undying is a perfect time to use that as well!
- First phase: Vayne is combo happy (especially after 50% HP) so if you have a shield user, that can be a boon. If not, having the extra health from Bubble/Bubble Belt could keep you alive. Larsa is here as well to provide some support, though you can't quite control it so you should really rely on yourself only to keep yourself healthy. If you can Blind him, that will also be beneficial to surviving the combos. Keep your health up through the end of the fight as phase two is coming up next...
- Second phase: Gabranth joins you for this part. Spells will be used against you now, so Shell is a good buff if accessible. Vayne is joined by five Sephira which can be a distraction for a melee based Ashe as they are difficult to target. If your Ashe is melee, consider using a Mote that can damage them. The biggest concern with the Sephira are their ability to immobilize and that they have different elemental affinities. If you have AoE Motes or use spells that are wind or neutral element, that could be a way to get rid of the Sephira. A fantastic time to use AoEs or high damage Motes likes Scathe is when Vayne is using one of the Vortice moves. All of the Sephira gather around Vayne, making it easy to hit all of them at once. Dispel Vayne's buffs if possible at the start and after the 50%-ish HP cutscene. After 50%-ish, Vayne is immune to magic for two minutes so focus on physicals or buffing up Gabranth to do the physicals.
- Third phase: The first time I tried this and went into the third phase, the active challenge icon was gone. I had thought that this meant that this achievement was only for the first two phases. When I tried the second time, I killed Vayne on the second phase with a quickening. The active challenge icon remained into the third phase. So, I guess you have to kill phase two and three with quickenings?? Very odd... The Undying will alternate between having physical and magical immunity. Keep an eye on the type of damage that is able to be used and alternate as possible. If you can only do one type of damage, use the off round to heal up or just run around to avoid attacks. The big thing to watch for is Teraflare (The Undying IS composed of parts from Sky Fortress Bahamut and looks a bit like Bahamut with gun wings, after all) so you'll need to ensure your health is high enough to withstand that. Make use of Bubble! Note that there is NO health bar to use for this leg of the fight. That means that you have to be careful to not kill him until you use a quickening. You'll know he's at 20% HP when he is flashing red, uses Perfect Defense, and then uses Teraflare when that wears out. Another avenue for damage is Gil Toss, since money doesn't matter at this point. Pay to win! If things aren't working out, consider working on getting better equipment via the bazaar and then trying again. Good luck!

***NOTE***: After beating the game and the credits role, start the game in Strong Mode! This will allow you to get the **Reks Smash** achievement and then make a new save with Strong Mode enabled in case you want to use it for some of the clean up.

### Zodiac Age ➡️ Postgame
...
It's time for a **WORLD TOUR**! The goal for now is to go around the world, starting from Cerobi Steppe, while getting all of the trophy and rare game as well as Espers. This will be the opportunity to grind trophy game for their rare steals needed for some of the critical pieces of loot to complete the bazaar. Late game bosses will be after completing this world tour and most of the bazaar.
...
**The Sky is Falling** (Items?): Collecting Meteorites typically involves using the Diamond Armlet on your party leader and opening treasure chests with a 5% chance of the Meteorite being the item to find. Otherwise, you'll get money or a Knot of Rust instead.
- Meteorite A and B types are all over the place. Find a convenient place to spawn close to where a chest will appear most of the time and rezone while checking the chest and hope to get the Meteorite you are looking for.
- Type C is rarer. I used the chest (chest 42 on the [maps](https://steamcommunity.com/sharedfiles/filedetails/?id=1292596668)) near the northeast exit of Zertinan Caverns - Drybeam Cavern, though I'm sure there is some other chest that is better.
- Type D is the rarest. Here are the locations that you can find the chests with them:
...
**Show Off I (cont'd)**: The Apsara is a fish type rare game found in Phon Coast - The Mauleia Strand. It appears once 10 Piranha have been killed in the Phon Coast. The best place to farm the Piranhas is in The Vaddu Strand zone. You don't have to chain them for the rare game to spawn.
...
**Proof of the Hunt: Cruel** (Trophy Game): The Bluesang is a headless humanoid type trophy game that is found in Cerobi Steppe - Crossfield. It has a 40% chance to spawn between the two windmills that are near the northern exit. There are four traps that are between these two windmills, but fortunately Bluesang tends to hang out just south of them.
- This is another good candidate for farming their item: Damascus Steel. They are used to make Gemsteel and 2 are required for each Gemsteel. Since you need to create 5 Gemsteel (3 with the bazaar trick), you will want to have 10 Damascus Steel (6 with the bazaar trick). It is possible to farm them from the Bune enemy in Pharos, but that won't be as reliable as this. It may be a good idea to clear out the surrounding monsters before attempting to steal the Damascus Steel. It'll be a bit slower, but safer. However, if you are capable of tanking or resisting the status effects of the nearby riff raff, just go for the steal instead.
...
**Carrot Stalk** (Hunts): To make Carrot the overgrown Malboro appear, you need to reach The Salikawood - Sun-dappled Path without having killed any monsters enroute to the location upon entering The Salikawood. Just turn off attack gambits and run through from your starting location to the zone. You'll know you are successful if the viera waiting for you tells you that you got there without making a racket.
- As stated earlier, I'm not really going to delve into actual combat techniques with hunts and such at this point since restrictions are off and you can handle it however. I simply used my Seitengrats to eliminate Carrot quickly without the hassle.

**Proof of the Hunt: Sickle** (Trophy Game): The Rageclaw is a mantis type trophy game that can be found in The Salikawood - Piebald Path. It will spawn when you hang out on the southern path for about a minute or so without killing any other monsters in the zone, appearing on the western path. If you did kill a monster, move two zones away and then try again. Once 60 seconds have elapsed, you can kill monsters at this point and proceed to where Rageclaw should appear. It can technically spawn at any opposite exit from where you wait.
- You can steal Sickle-Blade from it, which you need 2 of for the Orochi N bazaar good. If you don't have two of these already, I recommend getting them now from this trophy game.

**Show Off I (cont'd)**: A Wood Toad rare game will appear in The Salikawood - Corridor of Ages with a 20% spawn rate. It can be found close to the northern exit on a side path as you head south. It is invisible however, so it will be hard to find. While invisible, you won't be able to target it. You can hear it walking around and see a distortion. To actually attack it, you need to have someone with Reflect status and bounce a spell off of them to hit it. At that point, you can then hit it with physical attacks.

**Proof of the Hunt: Vengeful** (Trophy Game): The Arioch is a gargoyle type trophy game that appears in Nabreus Deadlands - The Slumbermead. It will appear in the southeast at a 40% chance of spawning.
- It has a Sage's Ring to steal, if you wish to have more than one.

**Ivalice Explorer (cont'd)**: The final Teleport Save Crystal is in Nabreus Deadlands - Succor Midst Sorrow. It is also a Crystalbug that is very strong, using Dark magic spells. Don't mess around and kill it quickly. Once you defeated it and the real save crystal appears, interact with it and this achievement will unlock.

**Show Off I (cont'd)**: The secret area of Nabreus Deadlands - The Fog Mutters has a rare game that only spawns when at least one character in your party has less than 20% HP remaining (called HP Critical). Velelu is a zombie type rare game and will spawn near the entrances to the zone. Probably the easiest way to make this happen is to turn off healing gambits and then attack yourself to the HP critical range or kill a party member and use a phoenix down. Velelu is also notable because it has a low chance of dropping the Durandal, which is associated with the **Sword of the Fog** achievement.

**Sword of the Fog** (Treasure?): This is unfortunate, as the best way to make the drop happen is to chain zombie/banshee type enemies to a max chain and then make Velelu spawn and kill it. Max chain means only a 7% chance of getting Durandal, but that is certainly better than 1% with no chain.
- You can also chain the Dead Bones in the Overlooking Eternity zone and then apply that chain to killing Velelu. It appears that does in fact affect the drops of the monster that breaks the chain!
- Keep in mind that Velelu will only spawn once per visit to Nabreus Deadlands. You will have to leave the area and return to fight it and try to get the sword again...

**Scalp the Golden Skull** (Steal/Poach): The numerous Dead Bones that spawn in Nabreus Deadlands - Overlooking Eternity are the target for this achievement. The Golden Skullcap helmet is a rare steal from them. Put on Thief's Cuffs, perhaps two characters with them, and start stealing while another character is killing them. Since these enemies have other items to steal, this makes for a slight RNG nightmare, though the quantity of enemies certainly helps. If you clear out the zone of Dead Bones, head out two zones away and return to try again. If it takes a while, expect to gain a lot of experience.

**Adding Insult to Injury** (Hunts): The Roblon mark is hiding in Nabreus Deadlands - Overlooking Eternity, a hidden zone associated with the Medallions side quest. 

**Bushi Basher** (Milestones): The Dead Bones in Nabreus Deadlands - Overlooking Eternity are an excellent way to get to 200 chain for this achievement. I ended up coupling that with **Sword of the Fog** and **Scalp the Golden Skull**.

**The Creature Collector** (Hunts): Right near the entrance to Necrohol of Nabudis - Hall of Slumbering Might from the Deadlands is the Goliath, a golem type mark. It has a very high defense so even with Seitengrat it will take a fair amount of time to kill.

**Show Off I (cont'd)**: The rare game Helvinek is a nightmare type fiend that can appear anywhere in Necrohol of Nabudis. For it to spawn, you must defeat 6 Oversouls, which randomly appear after killing enemies throughout the area. Once the 6 are defeated, Helvinek will show up. This rare game also has a rare drop of Grand Armor, which is needed to get the **Hell Horse Armor** achievement.
- One strategy that people are using to make this drop happen is to lure Helvinek close to a zone exit. If you kill the monster and then zone out before the experience and license points appear, Helvinek will appear in the next zone. Repeat this to get the chain up and improve your chance of getting the drop. Of course, if a drop happens, you should also grab it as you zone out.

**Love's Fury** (Side Quest): As part of the Medallions quest, you must fight Fury in Necrohol of Nabudis. If you have access to Dispel, you'll take out Fury very easily. Just don't let your Dispel caster get Berserk status.

**???** (Characters? Side Quest? Not sure...): The Esunaga spell becomes available in the secret Baknamy Merchant's shop after defeating Hydro at the Pharos entrance. Purchase it to unlock this achievement.

**Bravery's Horror** (Side Quest): As part of the Medallions quest, you must fight Humbaba Mistant in Necrohol of Nabudis. Protect and Dispel are critical, given the buffs on the boss and it's penchant for physical attacking. Defeating both this and Fury unlocks the final key in the Medallions quest, providing access to the Esper Chaos!

**The Walker of the Wheel** (Espers): Chaos is found in Necrohol of Nabudis, locked behind a door requiring the Medallion of Might, the final piece of the Medallions side quest. Prepare with the usual buffs as well as a gambit to deal with the Confuse status, preferably on someone who has a Bowline Sash. Protection from Disable is also helpful with the Black Belt.
- The main gimmick of the fight is that you can't use Attack. Chaos is surrounded by elementals that are affected by their opposing element while Chaos itself is only affected by earth element or non-elemental spells. Technicks such as Telekinesis and Soul Eater are good too.

**Uhlan's Mission** (Milestones): Earn 2 million clan points to unlock this achievement.

**Maximum Elvor-drive** (Items? Treasure?): Elvoret has a very rare chance of dropping Maximillian. I got very lucky and it dropped without a chain level bonus. Chaining Elvoret could be feasible by setting up gambits to only attack monsters with a wind weakness but you'll need to be a higher level and aggressively healing.

**Proof of the Hunt: Gravesoil** (Trophy Game): To get Vorres, a floating skull trophy game, to appear in Necrohol of Nabudis - Hall of the Ivory Covenant, you need to aggro a Dark Elemental that only appears near the door to Fury rarely. Once aggro'd escort it past the door to the other side of the passage and Vorres will appear. Some resources mention bringing the Dark Elemental TO the door, but that is not correct. Simply go past the door with the elemental.
- Vorres has Soul Powder as a rare steal, which is a necessary loot for making Empyreal Soul for the Tournesol. That means that you will need 3 of them in total. You can also get Soul Powder from Etém in Henne Mines (it's a grimoire drop or a rare steal). Given how painful it can be to farm Soul Powder from Vorres, it can make sense to get the rest from the Etém. You do get one Soul Powder as a reward from completing the hunt of Ixtab.

**Dead City Watch** (Hunts): Deathscythe, another of the floating skull type enemies, is found in Necrohol of Nabudis - Cloister of the Highborn, right by where the Ensanguined Shield chest spawns. To make it appear, you have to drop the HP of a character to critical range. It will put up a physical paling at 50% HP so use non-elemental spells.

**Reks' Legacy** (Side Quest): Complete five hunts given by residents in Nalbina: Trouble in the Hills, Adding Insult to Injury, Dead City Watch, The Creature Collector, and Carrot Stalk. When reporting to the people who posted the hunts, they call out to Jovy, a seeq, about the results of the hunt. Every time, Jovy looks at Vaan and runs off. After the fifth time, look for Jovy running around in West Ward and talk to them. You'll have a conversation about Jovy's inspiration and then this achievement unlocks.
...
**The Judge-Sal** (Espers): Exodus can be found at Mosphoran Highwaste - Empyrean Seat. Getting there is a puzzle in itself. Once you have gained access to Phon Coast for the first time, the shrines in the Bubbling Vale will become active. Using shrines will cause floatweed to create new paths around surrounding zones. Up to three can be active at any one time. Activate the following shrines: East Wind, Northeast Wind, and South Wind. Ride on the chocobo found at the Rays of Ashen Light zone, ride through Empyrean Way across the floatweed to a chocobo only path that leads into Skyreach Ridge. Head back into Babbling Vale, knock over the loose boulder, and activate the West Wind and Northwest Wind shrines. Now you can access Empyrean Seat.
- You cannot use items in this fight, so no Motes or Phoenix Downs. You are entirely reliant on magic for healing and damage, as well as physical attacks. Exodus loves to use Flare and Scathe. Both will do several thousand HP of damage to one or more targets. Having Bubble and Shell are good ideas, along with trying to spread your team out so that Scathe only hits one or two people. At 20% HP, a physical paling is put up AND Exodus has Reflect up. To hit Exodus now, you'll need attack magic with an Opal Ring. You can get Exodus in a loop with Dispel as the esper will try to reapply Reflect over and over again.

**Proof of the Hunt: Hide-covered** (Trophy Game): The Terror Titan is a tyrannosaur type trophy game located in Dalmasca Estersand - Broken Sands that has a 40% chance of spawning near the north exit instead of a Wild Saurian.

**Show Off I (cont'd)**: Greeden is a alligator type rare game that appears at Dalmasca Estersand - Banks of the Nebra after three real-time minutes have elapsed in the zone. It will appear in the middle of the shore area in the zone's north. This was the fiend that unlocked **Show Off I** for me.

**Show Off II** (Bestiary): The Ripe Rampager is a mandragora type rare game that spawns in Dalmasca Estersand - Yardang Labyrinth. It has a 33% chance of spawning in a dead end near the southwest exit to Outpost with each cactoid type enemy killed. There are three cactoids that spawn in when you get near to where they are in this zone. When I got Ripe Rampager to appear, I had killed two cactoid and then was approaching the third in the dead end when Ripe Rampager spawned in out of the ground. If it doesn't show up after the three cactoids are killed, run through Outpost to pass two zones and return to try again. It took a few tries to get Ripe Rampager to spawn so good luck and be persistent if it isn't showing up.

**Show Off II (cont'd)**: Minibug is a mimic type rare game that can appear in Barheim Passage - East-West Bypass. It has a 20% chance spawn rate, appearing in the eastern dead end. It does not appear as a treasure chest, so it'll be readily apparent that it has spawned since it'll be moving around.

**Proof of the Hunt: Bony** (Trophy Game): Ishteen is a reaper/floating skull type trophy game that can spawn in Barheim Passage, in either the East-West Bypass or The Zeviah Span zones. It will have a very low spawn chance initially, increasing by 2% with every 10 seconds in the zone. It also has a chance to spawn if you step on the trap in East-West Bypass that causes Disease at the intersection by the eastern zone exit.
- Ishteen has the Soul of Thamasa to steal for Tournesol creation. The fiend will spawn a couple of Dead Bones during the fight so you'll want to have a character manually pick those off while others work on stealing the item. Ishteen also loves Doom and Death, so appropriate healing gambits will also be helpful. Once stolen, you can run back to the save crystal two zones away to heal up and then repeat.

**Proof of the Hunt: Fur-scaled** (Trophy Game): Gavial is an alligator type trophy game that appears in Garamsythe Waterway - No. 10 Channel when the water is drained in the zone. Head down into the channel where water previously filled to where a one-time chest containing Hornito was located (chest 42). While in the area, Gavial will charge in from behind and attack.
- Gavial has Antarctic Wind to steal. While you'll need 2 of them, you can get them fairly easily from Feral Crocs in Tchita Uplands - Oliphzak Rise as their grimoire drop as well.

**Show Off II (cont'd)**: Drowned is a zombie type rare game that spawns in Garamsythe Waterway - No. 4 Cloaca Spur when the water is drained from the zone. To drain the water, close both sluice gates for No. 4 and No. 11 Channels. Drowned then has an increasing chance of appearing in the drained channel of the zone every 15 seconds after 5 minutes have elapsed in Garamsythe Waterway.

**The Impure** (Espers): Cúchulainn is a terrifying esper found in Garamsythe Waterway - No. 1 Cloaca. In order to access the boss, you must use the Old Sluice Key in Central Waterway Control in order to drain water from channels to access other sluice controls. Start with closing the gates to No. 10 and No. 3 channels. In No. 3 Cloaca Spur, use the No. 1 South Waterway Control to shut one of the gates for No. 1 Cloaca. Return to Central Waterway Control and swap sides, opening the sluice gates for No. 10 and 3, then shutting the gates for No. 11 and 4. Go into No. 4 Cloaca Spur to use the No. 1 North Waterway Control. Go back into Central Waterway Control and open No. 11's sluice gate while shutting No. 3 one more time. This will make all water drain out of No. 1 Cloaca. You can now reach Cúchulainn.
- One big thing to note about this boss is that there is a constant HP drain effect in the area during the fight. The esper also loves to use the Sap status effect to double the HP loss along with Disable to prevent healing. Good luck!

**Show Off II (cont'd)**: If you haven't taken out Lindbur Wolf yet, now is a perfect time to do so since making it appear and then killing it is required for **Proof of the Hunt: Fanged**. Get a chain of about 20 wolves in Dalmasca Westersand for the Lindbur Wolf to appear in the isolated section of Shimmering Horizons.

**Show Off I (cont'd)**: For completion sake, I killed Fideliant while trying to steal Gladius from Lindbur Wolf in the beginning of the game. Fideliant is a skeleton type rare game that has a 20% spawn chance in Dalmasca Westersand - The Midfault. It tends to appear near the fissure in the center of the zone, but can appear elsewhere.

**Proof of the Hunt: Fanged** (Trophy Game): The Kaiser Wolf is a wolf type trophy game that appears in Dalmasca Westersand - Corridor of Sand after the Lindbur Wolf has been dispatched while in the area. It will spawn on the lower east side of the zone.

**Show Off II (cont'd)**: Dustia is a reaper/floating skull type rare game that can appear in Dalmasca Westersand - Corridor of Sand, near the southwestern exit, when a character has less than 10% of HP remaining. It is notable for being a great early game experience point farm because it can easily be killed with a phoenix down and repeated using the zone out glitch. This isn't feasible for this achievement set because of the level caps, however.

**Show Off II (cont'd)**: Pineapple is a bomb type rare game that appears in Ogir-Yensa Sandsea - Platform 1 - Refinery. It has a 20% chance of spawning in one of six locations around the zone. Since this zone has a lot of enemies, which can reduce the chance of Pineapple appearing, I recommend sweeping through and cleaning out the zone as much as possible, rezoning, and continuing to sweep out remaining monsters. If Pineapple still doesn't show, keep rezoning and looking at the minimap for any new red spots to appear to know that you have spawned the rare game.

**Proof of the Hunt: Beaked** (Trophy Game): The Bull Chocobo is a black chocobo trophy game that appears in Ogir-Yensa Sandsea - South Tank Approach. It has a 40% chance to spawn at the southern most area of the zone. Use the western exit for rezoning until the chocobo appears.

**Proof of the Hunt: Maverick** (Trophy Game): Victanir is a horse type trophy game that appears in Nam-Yensa Sandsea - Yellow Sands. It has a 40% chance of spawning and is invisible initially.
- It is also a source of Wargod's Bands as a rare steal. These are needed for Empyreal Souls, so you will want to have 6 Wargod's Bands before killing Victanir.

**Show Off II (cont'd)**: Megabomb is a bomb type rare game found in Nam-Yensa Sandsea - Demesne of the Sandqueen. It can appear in one of several places around the zone after chaining over 20 Urutan-Yensa.

**Machinists Pleasures** (Milestones): This achievement unlocks after using a technick over 5000 times. Steal should make up a good number of these.

**Proof of the Hunt: Soulless** (Trophy Game): Zombie Lord is a trophy game that appears in The Tomb of Raithwall - Northfall Passage. It will only spawn if the minutes on the in-game clock are between 0 and 29. There are a few spots within the zone that it can spawn so you'll need to walk around to find it.

**Show Off II (cont'd)**: Cultsworn Lich is a rare game found in The Tomb of Raithwall - Southfall Passage. It only spawns when a regular Lich uses Divide, which only happens when at critical health. You can use 1000 Needles to easily put Lich down to 100 health remaining and then it will typically run off to divide. During Divide, Cultsworn Lich has a 20% chance of being summoned.
...
**Show Off II (cont'd)**: Molen is a golem type rare game that will appear in Zertinan Caverns - Hourglass Basin. Go to the secret passage side and kill off the Grenades hanging around there (or Catoblepas if the hunt is active). Wait for 10 seconds, looking out over to the other side and you'll see Molen start to walk into the zone. Return back over to that side to fight it (or use Seitengrat to take it out from afar, if you wish).

**Proof of the Hunt: Fell** (Trophy Game): Alteci is a behemoth type trophy game that appears in Zertinan Caverns - The Undershore. It will only appear if the player has an active chain of 12+ when entering or while earned in The Undershore. Mallicants are a good candidate for meeting this requirement.

**Proof of the Hunt: Metallic** (Trophy Game): Killbug is a mimic type trophy game that appears as a larger than normal treasure chest.

**Show Off II (cont'd)**: In Ozmone Plain - The Shred, there is a 20% chance for Bull Croc, an alligator rare game, to spawn on the north side. Shortly after it is killed, another rare game called Aeros, a white wyvern, will fly right toward you.

**The Foebreaker** (Milestones): Kill over 7500 enemies throughout the game. This shouldn't be too hard to do during the post game as you work to build up levels, build chains for item drops, and hunt for rare and trophy game.

**Proof of the Hunt: Maned** (Trophy Game): Nazarnir is a slepnir type rare game found in the dry Giza Plains - Starfall Field. It has a 40% chance of replacing the lone Slepnir that spawns in the southeast corner of the zone. You'll know it is Nazarnir because it'll have Shell and Haste active.

**Ready to Duel** (Treasure): A Dueling Mask can be found in Henne Mines - Phase 2 Dig. Near the entrance from Ore Separation is a path not on the map with a guaranteed one-time chest containing this item, and unlocking the achievement.

**Cartographer (cont'd)**: The Henne Mines candle urn is in Phase 2 Dig, revealing the remaining locations to enter.

**Piercing the Veil** (Treasure): The Fomalhaut can be found in Henne Mines - Phase 2 Dig right next to the map urn.
...
**Vagrant Story** (Steal/Poach): One of the toughest Entite type enemies, Vagrant Soul will wipe even high level parties. I ended up waiting to steal the Hunter's Blade from it until near the end when prepping for Trial Mode because it's Darkra and Feara are tough to handle. I set up a gambit on the non-stealer to do the healing and use Hi-Ethers if their MP < 10%. With a team that can handle 4000+ HP of damage, and a healer maintaining them, this rare steal should come fairly quickly. You will need to kill Vagrant Soul for the next one.

**Subterranean Bow Theft** (Steal/Poach): Luxollid is the other toughest Entite type enemy, though slightly easier than Vagrant Soul. However, the setup for stealing the Sagittarius bow is the same.
...
**Great Crystal Debugging** (Superbosses): Omega Mark XII can be found in The Great Crystal via a chain of Way Stones. It is only active once the Yiazmat hunt is accepted. Prepare with the usual buffs but also make use of Wither to reduce Omega's ridiculous attack power while the other party members keep the HP up. Once a Wither lands, the rest of the battle will become much more manageable. Keep laying on Wither while healing until people stop dying then switch to attacking. Eventually, Omega will Berserk whoever is doing the primary healing. Use Dispel to remove it and keep going. Once defeated, pick up the Omega Badge loot that drops. That's one part for the final Bazaar good: the Wyrmhero Blade. DO NOT miss grabbing it!!

**GilgaFish** (Minigame): To be able to progress to the final locations of the fishing minigame, there is a puzzle to be solved. In order to start the puzzle, you must have defeated Gilgamesh. Once done, you can start to get colored bottles while fishing. The bottles themselves have self-contained puzzles that relate to locations to search. You'll know you have found the correct location when you see a Faint Glow to interact with. The Faint Glow will not be at the location unless you have the associated color bottle. Touching the Faint Glow will get you an item and a piece of the final puzzle. Find all five messages to put together a final location to go to.
- Blue bottle:
  - Hint: Shift each letter by one to find the place.
  - Answer: An adrift boat in Nabreus Deadlands - Echoes of the Past.
- Black bottle:
  - Hint: Letters = Numbers
  - Answer: Rats in Garamsythe Waterway - Central Waterway Control lead you to the location.
- Green bottle:
  - Hint: Skip a letter, then repeat in reverse.
  - Answer: An abandoned hut in Salikawood - Piebald Path, hidden in the overgrowth.
- Red bottle:
  - Hint: Two words; one large, one small; jumbled among the peaks and valleys.
  - Answer: In Mosphoran Highwaste - Babbling Vale, there is one shrine that is not active in the northwest corner of the zone. You'll find the glow where you would operate any active shrine within the quiet shrine.
- Yellow bottle:
  - Hint: Brave moogles maintain these; ask them to start and stop.
  - Answer: The Cerobi Steppe has 10 windmills around the area. Approaching them will reveal their number, with number 1 being found closest to Balfonheim and then looping around to number 10 in The Northsward. Turn on the numbers listed in the note while turning off those not in the note. Some may already be in the correct position.
- Final location:
  - Hint: A old poem reveals the order; put the phrase together in order, then the letter to follow.
  - Answer: The elder of South Bank Village reveals a poem about River, Forest, Ash, Darkness, and Fire. The poem reveals the order. The four letter "words" are then placed next to each other in that order. Finally, the lone letters are placed next to each other in that same order. It makes the following phrase: underground bridge to nowhere (the "r" of nowhere is missing in the clue...). The location then is Barheim Passage. Go into the center north entrance of Zeviah Span from West Annex and approach the large rubble that makes this a dead end. Gilgamesh will appear and give you the Matamune fishing rod.

**Midstream Fished** (Minigame): Complete five perfect fishing outings to unlock the next location. The midstream fishing commands can be four or five inputs, adds the use of shoulder buttons, and commands can move vertically. It's a lot more to take in than the downstream location. Fortunately, as you keep at it, you'll start to notice that there are only so many commands that the game will use, relating to the type of fish being caught. Get familiar with the inputs that will show up and you'll get this. Note that getting the Matamune does NOT make the minigame any easier, it only allows accessing later locations.

**Cactoid's Compact** (Minigame): Complete five perfect fishing outings in the upstream location AND have found the Cactoid's Compact key item. Cactoid's Compact appears as one of the perfect fishing rewards 10% of the time (if you have the Matamune) so you will more than likely have to have more perfect fishing results than the minimum. The upstream difficulty is similar to midstream but adds some new combinations that involve more shoulder buttons.

**Sword in the Crystal** (Treasure): As you approach the top of The Great Crystal, where Ultima resides, you'll see a treasure crystal in the center of the zone. After Ultima's entrance, you can grab the chest during the fight to get the achievement. Of course, it's probably not worth grabbing until after finishing the battle (and stealing the megalixir for the **High Seraph** achievement).

**High Seraph** (Steal/Poach): Ultima has, unfortunately, items in all three steal slots. This means that you are more likely to get the common and uncommon steal than the rare, i.e. the megalixir that we want. This means that we will want to manipulate the RNG prior to the fight. Thankfully, you can enter Ultima's chamber without triggering the fight and set up the RNG to the correct position prior to proceeding up to the arena to start the fight.
- In game, have only one character in your party with access to Steal and Cure, preferably without Brawler as well. Fran will always meet these requirements, no matter what job is assigned to her (except Brawler). I'll write these directions assuming Fran was chosen as the solo character.
- Remove her weapon and equip armor that will prevent her taking damage when attacking herself. Equip Thief's Cuffs on her (not required, but provides more RNG positions to work with).
- Have no buffs applied. No negative status effects either (though if you used the save crystal, that shouldn't be a problem).
- Go into Ultima's zone and stand near the arena, but don't go in yet.
- Open up the Status page for Fran.
- Start up the RNG Helper. Select "File", then "Steal". Enter Fran's level and magic power into the Character Stats section of the Helper. If Fran has the Serenity augment unlocked in her license board, check the box. Select the Cure spell from the list. In theory, you could use other cure type spells in the drop down but I've heard that the Helper can have issues with that...
- Cast Cure on yourself. Record the value displayed in the Last heal text box. Press the Start button.
- Cast Cure more. Update the value in Last heal and press Continue. Repeat until you no longer have to manually update the Last heal text box as the Helper has now found your RNG position.
- With the RNG position tracking, look at the number of positions displayed under Thief's Cuffs Advance for Rare (located above the Continue button). If you have a lot of positions to go (over 10), attack yourself. Press the Consume button to advance 10 positions (this is the number in the Consume text box). If you have less than 10 positions remaining, use Cure to advance RNG slowly.
- What if Fran is too slow and you need to cast Haste or use a Hastega Mote? Applying Haste advances RNG two positions. Use that to help know how far away from Thief's Cuffs reaching the rare steal position to cast Haste ahead of time.
- Once you have zero positions remaining and your gambits are all set for stealing right away, head into the arena, skip the cutscene, and let Fran steal. If you see that a megalixir was stolen (you can see two or more items stolen, so pay close attention), bring in your remaining characters and fight Ultima!
- If you stole the megalixir and win the fight, the achievement should then unlock! Congrats!

**Fell Angel** (Sky Pirate's Den): After defeating Ultima, make absolutely certain that you look in the Clan Primer ASAP to unlock this achievement!!!

**Full Invisible Protection** (Treasure): Okay, so I'm finding that the RNG Helper application has some issues with how it identifies that a chest is going to appear or not. I'm assuming that is because of running the game on emulator instead of an actual PS2. I found that entering and reentering the zone will spawn a chest with 295 gil after 17 entries. This reveals that the chest appearance is on position 532 rather than 530, like the app is telling me. As a point of reference, the starting RNG position for me on a fresh boot up is 467 (fast CDVD off) or 441 (fast CDVD on). Zoning into Ultima's chamber consumes 3 RNG positions for me so I need to enter after consuming RNG position 529 so the chest appears. However, once the chest appeared, the RNG Helper was accurate about the contents of the chest. So, I used Cure to verify that 3 positions were consumed. I then had no room to attack so I cast Cure until the next position would have Item 2 in the contents for the chest. I then opened the chest and got the Gendarme. This is also one of the four pieces of the new Zodiac equipment for the **Zodiac's Hidden Gifts** achievement.
- I *highly* recommend grabbing at least three of them. This will make some later challenges much easier, especially the Larva Eater grind and Trial Mode's final trial.

**Euclid's Measured Steppes** (Treasure): In Cerobi Steppe - Crossfield, chest 77 has the rare chance to have Euclid's Sextant. Clear out the zone of all enemies first, ensuring they are no longer respawning and advancing RNG. Moving into the Crossfield zone would consume about 20 positions in RNG helper, but that wasn't consistent, making getting the chest to spawn a difficult task. Once spawned however (or if it is already there), consuming RNG to get the required treasure is the same as before: advance RNG with punches and Cure until Item 2 is the next position, then open the chest and receive your reward.

**Break Some Bones** (Treasure): In Cerobi Steppe - Feddik River, chest 46 has the rare chance of having the Cudgel, one of the secret Zodiac equipment for **Zodiac's Hidden Gifts** (though this one isn't invisible). Once you have the chest spawned, clear the zone of enemies and then use your RNG manipulation method of choice to get the new weapon!

**Gotta Have Faith, Faith, Faith** (Treasure): In Cerobi Steppe - The Terraced Bank, chest 32 has the rare chance of giving a Rod of Faith. The chest is located behind Windmill 4, if entering from North Liavell Hills. Once the chest has spawned, clear the zone of enemies and manipulate RNG to get the weapon. One thing to note: in all of these Cerobi Steppe treasure achievements, I found that just rezoning to get the chest to appear was MUCH more reliable than trying to use the RNG Helper. The variance of zoning affecting RNG position made it difficult to work with. Using the RNG Helper makes more sense when you are working with areas without enemies that you need to clear out and tons of chests that consume positions to determine if they should spawn or not.

**Ramuh's Gift** (Treasure): In Cerobi Steppe - Old Elanise Road, chest 88 contains the Staff of the Magi. As before, once the chest is spawned, clear out the riff raff and manipulate your way to an achievement. Also, I did get the Staff of the Magi that was in The Great Crystal, but I didn't notice until doing this batch of RNG treasure cleanup that this achievement didn't unlock with that one, despite the fact that the achievement doesn't specify that you have to get the one in Cerobi Steppe... Another thing to note is that there is a string of traps in front of the southern entrance to the zone. The second trap from the left appears to always be a rejuvenation "trap" so it is safe to walk over it.

**Hidden Tower Tango** (Treasure): A chest containing the invisible sword Trango Tower can be found in Pharos Subterra - Abyssal South, in the central room containing two dragon lich and a magick pot.  The chest has a 2% spawn rate and will appear in the southeast corner, near a column against the wall. I initially tried to use the RNG Helper to spawn the chest again and had no success at all, despite clearing the enemies in the central room and the adjacent space. This resulted in a lot of frustrating, which I am starting to feel about this set in general with the RNG stuff. I eventually decided to stick to zoning to spawn the chest, which eventually did spawn. Once that happened, RNG Helper did the rest to identify when the Trango Tower would be in the chest. Since this is the last of the four new Zodiac equipment, I also unlocked **Zodiac's Hidden Gifts** at the same time.

**Cactoids Commendation** (Minigame): The hidden shoals fishing location isn't much more difficult than the previous two difficulty levels, adding some new commands for the Nebra succulent type fish but using a lot of those seen in the upstream area. In order to progress to the final area, you must fish up the Cactoid Commendation after completing a perfect fishing run, which has a 10% chance of showing up, and that's it. No needing a certain number of perfect fishing runs. If you get it on your first try, lucky you!

**True River Lord** (Minigame): The final location, Den of the River Lord, has only one fish to catch initially. The King of the Nebra has to be caught nine times in order to get Lu Shang's Badge. Since it is initially the only fish to catch, there is only one command to input: R1, L2, Square, Up, R2, L1, Right, Cross. If you memorize the input, you can start entering the command as soon as it appears on screen since it'll be the same every time. If you are having difficulty, keep at it. Also, when the fish swims horizontally, the increased amount of time will help you get the input down. Unfortunately, you can also end up getting empty bottles as well, which means that the King of the Nebra loses no lives for that successful input.

**Keeper of Precepts** (Steal/Poach): With my levels buffed up into the 90s and all areas explored with the exception of Zodiark's room, it was time to finally tackle this final esper. To prepare for stealing, the comments of this achievement provided some good insights. I followed the strategy provided by [RestlessTome](https://retroachievements.org/user/RestlessTome).
- After making my way to the entrance of Zodiark's arena, I started preparing my RNG manipulation, using Fran with no weapon, wearing the Thief's Cuffs, turning off gambits, and casting Cure. Once I had my position, I put myself into three positions away from acquiring the rare steal with the Thief's Cuffs. I also prepared Vaan with the Thief's Cuffs and gambits off.
- I entered the zone, skipped the cutscene, then issued the Steal command. Zodiark casts Darkja, killing Fran. Once prompted, I put Vaan into the party, issued the Steal command again, and got the Trango Tower. I then restored my party right away, reviving Fran, bringing in the third character, and turning on gambits to start the battle proper.
- Once Zodiark was defeated, I got the achievement! Now, OPEN THE SKY PIRATE'S DEN!!!

**High Summoner** (Sky Pirate's Den): With the final summon obtained, the Belias statue is unlocked, along with this achievement, once opening the Clan Primer.

**Zodiac Knight** (Sky Pirate's Den): With Zodiark obtained, this achievement is unlocked upon opening the Clan Primer.

**Cartographer** (Sky Pirate's Den): If this was your final location on the map (remember that one-time dungeons, to include Sky Fortress Bahamut, do not factor toward this), then opening the Clan Primer will unlock this achievement.
- This one is particularly dangerous in missing, since there is no notification that you have reached all areas in the game. Make absolutely certain that, as you get close to entering all zones, that you keep track of what is left and occasionally checking the Clan Primer.
- Also, consider making multiple save slots near the end so that you don't lose too much progress if you do happen to miss this and load a save with it already unlocked.

**Zodiac's Gift (cont'd)**: After defeating Zodiark, I could use it's base of operations for manipulating RNG to spawn the chest. You must have acquired all other one-time chests in the Special Charter Shaft before using this manipulation since their spawning consumes unpredictable RNG positions.
- With those requirements met, enter Zodiark's arena from the back side. Remove all but one character that can cast Cure. Unequip weapons and have armor/accessories that don't add status effects.
- In the RNG Helper, update the character's level, magic power, and if they have Serenity. For chest data, appear chance is 1%, RNG position is 8, and gil chance is 0%. No other boxes matter.
- Cure to find your current RNG position. Once you know how far away you are from Advance to Appear reaching 0, attack or Cure yourself until then. Once it hits 0, enter the Special Charter Shaft zone.
- Bring in your other party members, if needed, and reequip your previously solo character. Make your way to the stairs where the chest should now be. Open it for the Zodiac Spear and achievement. Note that the Diamond Armlet is not required as all slots have the weapon.

**Shield of the Wroth God** (Treasure): In Sochen Cave Palace, make your way back to the Hell Wyrm's chamber. Ensure the enemies near the door are killed and no others are around (you don't have to eliminate all of them in the zone, just near the door and on the way to it). As with other RNG manipulations, go to one character, unequip weapons and armor/accessories that provide status effects. For the chest data, appear chance is 1%, RNG position is 1, and gil chance is 0%. No other boxes matter. Cast Cure to find your current RNG position and ensure that it is consistently advancing under your control, then bring the Advance to Appear to 0 and open the door to the Hell Wyrm's arena. Walk toward the north end of the room where the chest should have spawned and it will be there as you get close.

**Frozen Glacier Seed** (Treasure): In Paramina Rift - Karydine Glacier is another 1% spawn chance treasure containing a Baltoro's Seed in all slots with 0% gil chance. I had success with using RNG position 2 for the chest to appear.

**Big Game Hunter II** (Bestiary): If you are like me and Yiazmat is your final entry, this achievement will unlock as soon as you target it or vice versa. You still need to defeat the final enemy to have it actually added to the Bestiary so that you can get Ba'Gamnan's statue added to the Sky Pirate's Den.

**Hunter Extraordinaire** (Steal/Poach): To get the Bone of Byblos from Yiazmat, you will need to set RNG position to 16 in the Advance for Rare (thanks to [jpc241](https://retroachievements.org/user/jpc421) for this detail) while IN Ridorana Cataract - Colosseum, but before approaching Yiazmat to start the fight. This is because after the cutscene plays for the start of the fight, RNG is advanced by that much as it basically reloads the zone (and all the chests and traps).
- Once you have your RNG position set up, and before advancing toward Yiazmat, bring in a second character who will actually do the stealing. Equip them with the Thief's Cuffs and turn off gambits on both characters.
- Advance toward Yiazmat, watch or skip the cutscene, then let Yiazmat target the party leader, the one not stealing. Once you see the aggro line, tell the second character to steal and pull back the party leader to avoid taking damage. If done properly (no one was attacked or attacking), the steal will be the Bone of Byblos!
- With the weapon stolen, now defeat Yiazmat! The key to this fight: the Break technicks. Set up gambits that apply Wither and Addle first. This will reduce the damage that Yiazmat can dole out and increase your immediate survivability. Let those statuses stack on Yiazmat until you no longer see success messages. Now switch to applying the other two Break technicks: Shear and Expose. Once complete, have all characters keep maintaining buffs, attacking, and reviving (especially once Yiazmat starts using Death Strike regularly). At 20% HP, Yiazmat will put up Reflect on the party. Dispel it, restore buffs and heal as needed, then finish up!

**Scrivener** (Sky Pirate's Den): With the felling of your final enemy and placing their entry in the Bestiary, the Ba'Gamnan statue is unlocked. Open up the Clan Primer to get the achievement.
- **NOTE**: The other achievements for the bestiary (**Hunter of Monsters**, **Big Game Hunter**, and **Show Off**) are triggered on interacting with a monster, NOT for actually adding the entry to the bestiary. You MUST kill a monster to add it to the bestiary proper which is what actually unlocks **Scrivener**.

**Order of Ambrosia** (Sky Pirate's Den): Having the final statue in the Sky Pirate's Den will also unlock this achievement at the same time. Congrats on the "platinum" status!

**Farewell to a Legend** (Hunts): Return to Montblanc to inform him of your victory. Upon receiving your reward, you'll unlock this achievement. Congrats!

**Dragon Crest** and **Master Deal Hunter** (Bazaar): With the receipt of your reward for defeating Yiazmat, you now have the items needed to make the Wyrmhero Blade. Sell the Omega Badge, Godslayer's Badge, and Lu Shang's Badge to unlock the sword, then buy it to get the last bazaar good, completing both achievements!

**Mist Master** (Characters?): This was rough... Getting the Mist Charges to line up while also having more quickenings to unleash was very much a luck of the draw. Too late, I saw a great strategy proposed by [SayuriMio](https://retroachievements.org/user/SayuriMio): have three characters with only level 1 quickenings and give them the level 3 espers. This means that they only have 1 quickening to appear in the roulette but have 3 charges to work with. Then, while using the quickenings, focus on one character until all of their charges run out. If a Mist Charge option ever shows up, use it. Keep rotating through quickenings and building up the chain. You'll still have to contend with hoping that a Mist Charge shows up, but this gives you much more flexibility to make that happen.
- The level 3 espers are Famfrit, Chaos, Ultima, and Zodiark.

**Tsunami Bomb** and other esper ultimate attack achievements (Espers): I never really use espers other than the one time that it was needed for the achievement so I'm knocking them out now, finally. Just summon one of your espers, take control of them, and then select the last option in the esper's Technicks menu.

**Eating Larva** (Treasure): While there are a couple of methods out there to improve your chances of getting Larva Eater to drop the Hunter's Blade F, chaining Gargoyle Barons and then using Mom Bombs for building the kill count without breaking the chain is arguably the most convenient.
- The setup: Chain Gargoyle Barons in Giruvegan. The best spot is Gate of Fire where there are plenty of Gargoyle Barons and only a few Vivian. Manually target the Gargoyle Barons and avoid picking up their loot to increase chain levels quicker. If you run out of them, travel back two zones to The Aadha Water-Steps and return to respawn them. On average, I can reach max chain at around 22-26 kills, with only having to leave Gate of Fire once to restock on Gargoyle Barons. Once at max chain level, head into The Great Crystal. Reach Way Stone XX.
- The Loop: Have two characters gambits set up for healing duty. The party leader should have gambits set up for casting Toxify. If you happen to have grabbed at least three Gendarme from Ultima's chamber, healing will probably not even be necessary since it'll block most attacks AND absorb elemental damage. Toxify will poison the Mom Bombs, potentially getting them to self destruct or die from the poison while not breaking the chain. The loop is a run around the three zones south of Way Stone XX killing the Mom Bombs with this setup, accruing the kills needed to spawn Larva Eater. Toxifying Mom Bombs for the 255 kills to spawn Larva Eater requires 17 laps (255 kills with 15 Mom Bombs per lap). The main danger of this loop is that Reapers can potentially spawn at the Way Stone. Avoid them at all cost and continue the loop.
  - A riskier strategy (that can break your chain if you aren't careful) but can help speed things up is to have your Toxify character also cast Bio to do some damage and inflict Sap. Use a gambit that only casts Bio if a foe has 100% HP and then set Toxify to be used if a foe has Sap status. This is risky because if Bio is cast too many times, you'll inadvertently kill a Mom Bomb yourself and end the chain. So, the ideal way to do this is to draw the aggro of all five Mom Bombs in a zone by running in while holding R2 and then when they are all together, let go of R2 and let the gambits do the work. This avoids the risk of casting Bio too many times if Mom Bombs are scattered around and not blowing up right away.
  - Something that I noticed was that when Reapers show up, if I change the direction of my loop, the Reapers go away. On my winning run that finally netted the Hunter's Blade F, I would swap directions every 5 laps. I never saw Reapers at the Way Stone. I'd love more conclusive evidence that this works but I only realized that this was happening when I was on my final attempt so I don't have enough data.
- The Larva Eater: Once the Larva Eater has spawned at the Way Stone, kill it traditionally. It will continue the chain (it's the same type as the Gargoyle Barons) which means that the chance of it dropping the weapon is increased. If Reapers are in the zone as well as the Larva Eater, use a ranged weapon or single target spell to get Larva Eater's attention without drawing the Reapers' aggro.
  - In the interest of further automation without having to update gambits whenever the Larva Eater shows up, I set my attack gambits on all three characters to target only ice weak foes. Larva Eater is weak to ice while Mom Bombs are weak to water and Reapers are weak to holy.
- Didn't get the weapon? Continue to make the loop. Once you have spawned Larva Eater the first time, it will respawn after a potentially smaller number of kills if you don't leave The Great Crystal, between 30 and 255 kills. So, if you are lucky, it'll take less laps for Larva Eater to show up again. Given the amount of luck for this, expect considerable time to complete this. It might be best to do this after completing the game and a lot of the set, since having higher levels and better gear will make this grind much quicker and easier. It took me about 15 kills of the Larva Eater to get the weapon to finally drop. Dig in and hope that RNG is blessing you in your attempts!

**Magick Seed** (Steal/Poach): An excellent spot to set up RNG manipulation and steal a Baltoro's Seed from a magick pot is in Pharos Subterra - Penumbra North. There is a lone magick pot in the rooms after the Phoenix boss chamber. Go into the zone that the magick pot is alone, set up the RNG position so that the next steal is a rare steal, then steal! Easy! Run out to the boss chamber and then if you want to steal another Baltoro's Seed (or more), head one more zone away, go back and repeat! Having a stock of Baltoro's Seeds is a good idea for Trial Mode...

**Renewing the Night** (Treasure): Nightwalker is the monster that gives up the Renewing Morion as a rare drop in Pharos Subterra. Unfortunately, they only appear if you wait for 7 minutes in a room with a Pedestal of Night. To improve the odds of getting the drop, building chain levels on a similar monster would be ideal. To do so, [Sonicshadowsilver2](https://retroachievements.org/user/Sonicshadowsilver2) suggests the following:
- Head to Dalmasca Westersand. Get Dustia to appear in Corridor of Sand by having a character with less than 10% HP. Kill it and run out of the zone before the experience and LP are displayed (zone out glitch). This raises the chain without despawning Dustia.
  - If you do inadvertently cause Dustia to be killed and it won't respawn, you'll need to leave Dalmasca Westersand to Ogir-Yensa Sandsea and come back to continue. Going into Rabanastre will end the chain.
- Raise chain until you max chain level. Since you aren't picking up loot bags, you should hit max chain level in 25 kills. Now you can head back to The Pharos. Unfortunately, teleport save crystals are not available for this as this would kill the chain. Take the Strahl instead! Head to the Western Divide without killing any monsters and board the airship, heading for Ridorana Cataract.
- Run through Ridorana and enter The Pharos. Take the elevator down to the Penumbra level. Head directly for the northwest room. Again, no killing any monsters. I turned off gambits to ensure that I wasn't attacking rather than updating gambits to turn off attack gambits. Holding R2 could also work for this.
- While near the Pedestal of Night, wait for seven minutes. Turn attack gambits back on. Use emulator fast forward to pass the time. Once Nightwalker appears, it'll die and drop a high level loot bag. If you are lucky, you'll get it on your first attempt. Good luck!!
  - It took me 12 Nightwalkers to get the Renewing Morion. Since this is a rare drop (18%), not a very rare (7%), I was probably on the unlucky side for this one.
- To fight Nightwalker again, turn off gambits and run to the elevator. You can return directly to the spawn point again (I tested that Nightwalker does appear without leaving The Pharos), I recommend stepping out of The Pharos so that it resets the Penumbra Interior monsters. Otherwise, you'll have a gathering waiting for you as you step off the elevator.
...
**Deadly Renewal Walk** (Steal/Poach): For poaching when at high levels, the best thing is to have gambits set up to use Sight Unseeing on a blind character targeting a foe nearby then Poach when an enemy is in HP Critical status. It can be the same character or different characters. While grinding for these rare poaches, you'll want any attack gambits off other than these and then manually attack with the non-blind characters on monsters that are not the targets for poaching.
...
**Branchway Cannon** (Steal/Poach): You can poach a Ras Algathi from the rare game Phyllo (5% chance to get it) in Golmore Jungle - The Branchway. Phyllo only has a 20% chance of spawning in two locations in the zone, so this may take a bit of time to get the weapon and achievement.
...
**Mine's Holy Dragon** (Steal/Poach): The Holy Lance is the rare poach from Gizamaluk, which can be found in Henne Mines - Phase 2 Shaft. The problem here is that there are swarms of Abysteel around three of the four Gizamaluk that appear here. Sight Unseeing/Poach doesn't work on Abysteel so you'll need to eliminate them with your other characters. Abysteel are weak to holy and Gizamaluk is not. Use that to your advantage! Put gambits on the other two characters to attack only holy-week foes while your poacher has their Sight Unseeing/Poach gambits. That'll make passing through Phase 2 Shaft to grind for the lance much quicker. This grind will be made much easier if you have access to Zodiark's arena to quickly pass through two zones to reset Phase 2 Shaft.

**Upland Doubling** (Steal/Poach): The easiest of the poaching achievements to do, given that there are TONS of coeurl all over Tchita Uplands. Set up your poaching gambits and walk around and you'll get this fairly quickly, despite this being a rare poach. Getting Embroidered Tippets is great too, since they'll help speed up your leveling for Trial Mode.
- ***TODO***: Should probably move this up earlier in the roadmap... Having early access to the accessory is a real boon.

**Sword of the Fog** (Treasure): Getting the Durandal, a very rare drop from the rare game Velelu, is similar to some of the other drop manipulations we've done. Use Banshees in Nabreus Deadlands - The Slumbermead to build up the chain level with a quick two zone location using the save spot zone, Succor Midst Sorrow. There are two Banshees that consistently spawn: in the water and reeds north of chest 19 (don't go too far south or you'll approach a Crusader and possibly break the chain), and in the water north of and between chests 21 and 22 (don't go too far west where the Emeralditan is). Use caution while grinding these two Banshees as there is a Foobar that will spawn east of chest 21. Once your chain level is maxed, head through the secret passage to The Fog Mutters with a character's health less than 20%. This leads to the main issue with this grind: Velelu only spawns once per visit to Nabreus Deadlands. You'll have to leave the whole area and return to try another attempt.
- Good news! Velelu is susceptible to the zone-out glitch as well! When you meet the requirements for it to spawn, approach the fiend and get it to chase you toward the zone exit. Head back in and try to get Velelu to get as close to the zone line as possible. Head in and out of the zone as necessary to avoid anything devastating. Once positioned properly, kill Velelu while running up against it so that you cross the zone line (hopefully) as the loot bag drops while also not accruing XP or LP. Now, reenter The Fog Mutters again and, as long as a party member is still below 20% HP, Velelu will respawn near the opposite zone exit. Repeat until you get the sword!
- Given that this is a 7% drop chance (assuming max chain level), expect this to take a good amount of time to get the Durandal.

**Hell Horse Armor** (Treasure): This is the primary example of using the zone out glitch. Without being able to build a chain before fighting Helvinek, because of having to kill Oversouls (and the enemies in the Necrohol to even get Oversouls to appear!), you can use the zone out glitch to get chain levels on Helvinek and continue to kill and get the loot until you get the Grand Armor. Since Helvinek won't be considered "killed" while using the glitch, the conditions for it to spawn will always be met as you enter a new zone. The chain levels should build up quickly!
- While attacking, position yourself closely to the zone exit line. Use the chain indication to know when you have made the kill to begin moving through the zone line. Once at max chain level, you now need to consider Helvinek's position to the zone line so that you can grab the loot as it dies and then get out of the zone. It may be best to have other character(s) do the fighting while the controlling character is pushing Helvinek into position.
- If there is any risk at all of not being able to pick up the loot before the XP and LP numbers appear, prioritize escaping the zone over the loot! Setting up another chance at Helvinek takes far longer than just letting it respawn and trying again.
- When Helvinek dies, you have approximately 1.5-2 seconds for it's death animation to show the XP/LP numbers. There is a small window to grab the loot and run to the zone exit so you don't have to get Helvinek right next to the exit.
- If a Dark Elemental shows up, you will want to zone away if you see Helvinek cue up any magic attacks. Dark Elemental getting aggressive could cause gambit attackers to break the chain. Be wary. It's not the end of the world if the chain breaks, so long as you maintain Helvinek spawning with the zone out glitch, but you will have to build the chain again.

**Waterway Stalker** (Steal/Poach): This can be accomplished when preparing for the fight with Cúchulainn. In Garamsythe Waterway, in either the No. 3 or 4 Cloaca Spur, a Gespenst, a reaper type monster, will appear in the drained areas if the side's sluice gates are shut. You can easily get it to spawn while in the upper paths and it will teleport near you. Steal and then run around two zones (easy to do in this area with the many zone exits) to respawn it with new items to steal. Even though it is a rare steal, this shouldn't take too long to do with how quickly you can respawn the fiend and try for the steal again.

**Knot a Problem** (Challenge): Hopefully, you have been making use of Knots of Rust to build up the damage of a Dark Matter throughout the game (or rebuilt it if you have used one at all and retained that use without reloading a save). Equip Thief's Cuffs before the final fight with The Undying so that you can improve your steal rate for getting the Dark Matter. Once the battle begins, maintain gambits only to steal and maintain health on the party (buffs don't matter so much since The Undying will just remove them). Once you have successfully stolen (the Dark Matter is all The Undying has), proceed with damaging the boss. You'll know that you have succeeded as well since the active challenge icon will appear once you have stolen the Dark Matter. Once it puts up Perfect Defense, you know that it has hit the 20% HP threshold. Wait out the paling and heal up/buff up for Teraflare. Once that is unleashed and the paling falls, throw the Dark Matter. As long as you maxed out the amount of damage that Dark Matter can do (60,000 HP), you should kill The Undying with the one Dark Matter at the 20% HP point (45,670 HP).
- If you want to make sure that your Dark Matter's output has been maxed out, or at least exceeds 46k of damage, make a save and throw one to see if it is enough. If you don't have one to test with, there is one in the chest right in front of you once on board the Bahamut. Use it on one of the endless enemies to see the damage, reset the game, then either continue using Knots of Rust or proceed to The Undying.

### Trial Mode

I am classifying all of the Trial Mode achievements separately from the main game roadmap since you cannot carry over anything from Trial Mode into the main game (I'm seeing something about saving every 10 stages... is that even in IZJS? Or just TZA?). Maybe it should have its own roadmap? Perhaps I can plot out a way to do the mode in one shot...

Seitengrat is allowed in everything but trials 95 and above. However, there is one achievement that requires completing the entire run of Trial Mode in one shot without Seitengrat. If you feel that your party is strong enough to complete the trials without Seitengrat at all, ensure that you have it unequipped prior to the start of your run.

Prepare for Trial Mode runs by setting up your characters in the main game. Put on the equipment they'll need, learn all licenses that you need (if you haven't already by the end of the postgame grind), have accessories on hand to swap to as needed for certain challenges (Ribbons, Thief's Cuffs, etc.). Stock up on items! Having ethers, hi-ethers, and elixirs will be beneficial. Since the non-Seitengrat invisible zodiac equipment isn't prohibited, I recommend making good use of them. I highly recommend getting a hold of enough Gendarme for the whole cast (or at least three of them).
...
- Trial 9 - Poach: Cultsworn Lich (stand to left of chest on right side of room)
- Trial 12 - Steal: Melt (kill five Jelly then stand in front of gate switch for several seconds without moving)
- Trial 28 - Steal: Cubus (stand in one of the four corners)
  - Retain the save after Trial 30!
- Trial 31 - Poach: Apsara (head straight past several water puddles and get behind large dusk stone; has more than one poach item...)
  - Retain the save after Trial 40!
- Trial 43 - Poach: Pallicant (run to door in distance and return to start)
  - Retain the save after Trial 60!
- Trial 64 - Steal: Vorres (go to far side of room, near treasure chests)
- Trial 69 - Poach: Spee (go to far side of room, near treasure chests... but it seemed to show up when I went to the center of the room...)
- Trial 70 - Steal: Crypt Bunny (go to far side of room, near treasure chests; take out Krjn so she doesn't defeat the enemies before you steal; I stole Phoenix Down but it didn't unlock...)
  - Retain the save after Trial 70!
- Trial 72 - Steal: Overlord (this is the first one that requires stealing a specific item but has multiple steal slots filled, meaning RNG manipulation???)
  - Retain the save after Trial 80!
- Trial 82 - Steal: Crystal Knight (stand in center)
- Trial 87 - Steal: Hell Wyrm (second one that requires stealing specific item with multiple steal slots filled... should be RNG manipulatable)
- Trial 88 - Steal: Evil Spirit (kill a bunch of Forbidden without killing Disma)
- Trial 89 - Steal: Fafnir (third one to require specific steal, must also kill with a single item (Warp Mote, it seems?); Jegged says there is only one item to steal...)
- Trial 95 - Steal: Ultima (fourth one, though there are two chances)
- Trial 96 - Steal or Poach: Glaring Eye (kill Abysteel without killing them all and one will hopefully spawn; Jegged says only Poach...)
