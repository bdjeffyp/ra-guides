...
- RA user [Mimicmatter](https://retroachievements.org/user/mimicmatter) went to Tchita Uplands to get the Float spell and used Float with Vanish to stay hidden from enemies while making the journey back and forth to spawn the chest.
...
**Show Off I and II (cont'd)**: In The Salikawood - Sun-dappled Path, eliminating the Wyldhares here will cause Spee to spawn in the southwest corner of the zone. Spee can cause confusion and absorbs Fire element.
...
**Show Off I and II (cont'd)**: The secret area of Nabreus Deadlands - The Fog Mutters has a rare game that only spawns when at least one character in your party has less than 20% HP remaining (called HP Critical). Velelu is a zombie type rare game and will spawn near the entrances to the zone. Probably the easiest way to make this happen is to turn off healing gambits and then attack yourself to the HP critical range or kill a party member and use a phoenix down. Velelu is also notable because it has a low chance of dropping the Durandal, which is associated with the **Sword of the Fog** achievement.
